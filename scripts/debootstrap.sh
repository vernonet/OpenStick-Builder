...
# testing copy leds config files, comment out the following 5 lines if you don't want automatic LED setup 
...
ln -s /etc/systemd/system/leds_config.service  ${CHROOT}/etc/systemd/system/multi-user.target.wants/leds_config.service
